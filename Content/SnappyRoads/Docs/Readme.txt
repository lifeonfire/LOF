...
- Introduce new RoadTools widget with numerous workflow enhancements
- Add road baking capability with HISM support
- Intesection BP: add soft references for World Partition system support
- Fence BP: add 'Keep Horizontal' option
- WheeledVehicle BP: use chaos vehicle plugin
- Code refactoring
- Lots of bug fixes and other changes

v 2.7 20231027
- Add an intersection Blueprint
- Add a simple fence Blueprint
- Add a wheeled vehicle Blueprint
- Add stretchable freeway columns
- Add new collision meshes for freeway assets
- Traffic: Improve collision detection, including with player pawn
- Move SplineMesh generation to a component
- Code refactoring
- Lots of fixes
